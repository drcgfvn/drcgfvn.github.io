(() => {
  ...
  function o(e) {
    ...
    for (const e of l.querySelectorAll(".wpcf7-form-control-wrap"))
      if (
        ...
        e.dataset.name &&
          (f.push(e.dataset.name), e.setAttribute("data-under-validation", "1"), e.contains(o)))
      )
        break;
  ...
  const c = (e, t, a, n) => {
      ...
      const { scope: o = e, ...c } = null != n ? n : {},
        s = `${null === (r = e.wpcf7) || void 0 === r ? void 0 : r.unitTag}-ve-${t}`.replaceAll(
          /[^0-9a-z_-]+/gi,
          "",
        ),
    ...
    s = (e, t) => {
      ...
      (null === (n = e.wpcf7.parent.querySelector(`.screen-reader-response ul li#${r}`)) ||
        void 0 === n ||
        n.remove(),
