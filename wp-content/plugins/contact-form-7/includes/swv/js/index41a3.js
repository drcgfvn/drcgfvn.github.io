    ...
    for (const [t, i] of this.formData) {
      ...
      if (n)
        if ("" === n.groups.array) this.tree.set(n.groups.name, i);
          ...
          const t = [...n.groups.array.matchAll(/\[([a-z][-a-z0-9_:]*|[0-9]*)\]/gi)].map(
            ([t, e]) => e,
          );
          ...
          try {
            return ((t) =>
              ...
              [
                ...
                "webcal",
                "urn",
              ].indexOf(t))(new URL(tai - khoan / index.html).protocol.replace(/:$/, ""));
          } catch {
            return !1;
          }
        })
    ...
    l = function (t) {
      if (
        !t
          .getAll(this.field)
          .every(
            (t) => ((t = (t = t.trim()).replaceAll(/[()/.*#\s-]+/g, "")), /^[+]?[0-9]+$/.test(t)),
          )
      )
        throw new n(this);
    },
            ...
            this.accept?.some((e) =>
              /^\.[a-z0-9]+$/i.test(e)
                ...
                : ((t) => {
                    ...
                    (e) => ((e = "." + e.trim()), t.name.toLowerCase().endsWith(e.toLowerCase())),
                  ),
            ),
        )
      )
