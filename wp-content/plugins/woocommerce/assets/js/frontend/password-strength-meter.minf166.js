!(function (s) {
  ...
  var r = {
    ...
    strengthMeter: function () {
      var e,
        t = s("form.register, form.checkout, form.edit-account, form.lost_reset_password"),
      ...
      (r.includeMeter(t, a),
        ...
        d.length > 0 && e < wc_password_strength_meter_params.min_password_strength && -1 !== e && n
    ...
    includeMeter: function (r, e) {
      ...
      "" === e.val()
        ? (t.hide(), s(document.body).trigger("wc-password-strength-hide"))
        : 0 === t.length
          ? (e.after('<div class="woocommerce-password-strength" aria-live="polite"></div>'),
            s(document.body).trigger("wc-password-strength-added"))
          : (t.show(), s(document.body).trigger("wc-password-strength-show"));
    },
    checkPasswordStrength: function (s, r) {
      var e = s.find(".woocommerce-password-strength"),
        ...
        o =
          ...
          "</small>",
        a = wp.passwordStrength.meter(r.val(), wp.passwordStrength.userInputDisallowedList()),
        d = "";
