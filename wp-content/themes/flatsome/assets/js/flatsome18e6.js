!(function () {
    ...
    i = {
          ...
          (e.addClass("current-dropdown"),
            ...
            (function (e) {
              ...
              if (r) {
                ...
                t.css({
                  width: s ? o - i.width() : o,
                  ...(!c && { left: e.left - n.left + 15 }),
                  ...(c && { right: 15 - (e.right - n.right) }),
                });
              }
              if (a) {
                t.css({ inset: "0" });
                const e = document.body,
                  ...
                  a = e.clientWidth;
                t.css({
                  ...(!c && { width: s ? a - i.get(0).getBoundingClientRect().right : a }),
                  ...(c && { width: s ? i.get(0).getBoundingClientRect().left : a }),
                  ...(!c && { left: n.left - o.left }),
                  ...(c && { right: -(n.right - o.right) }),
                });
              }
              if ((r || a) && !s) {
                let e = null;
                if (
                  (i.closest("#top-bar").length && (e = document.querySelector("#top-bar")),
                  i.closest("#masthead").length && (e = document.querySelector("#masthead")),
                  i.closest("#wide-nav").length && (e = document.querySelector("#wide-nav")),
                  null !== e)
                ) {
              ...
              t.each(function (e, h) {
                ...
                (f.on("touchstart click", function (e) {
                  ("touchstart" === e.type && (y = !0),
                    "click" === e.type && y && (y && !m && e.preventDefault(), (m = !0)));
                }),
                  n || p
                    ? ((u = !0),
                      f.on("click", "a:first", function (e) {
                        if ((e.preventDefault(), (d = f), f.hasClass("current-dropdown")))
                          return (i(f), void s(l, "click"));
                        (a(t),
                          o(f),
                          r(l, "click"),
            ...
            jQuery(".mobile-sidebar-slide", t).each((t, o) => {
              ...
              jQuery(
                ...
                const i = jQuery(o),
                  ...
                  l = jQuery(
                    ["> .toggle", '> a[href="#"]', n && "> a"].filter(Boolean).join(","),
                    r,
                  ),
        ...
        Flatsome.behavior("scroll-to", {
          attach() {
            ...
            (o.length
              ...
              : ((o = jQuery('<div class="scroll-to-bullets hide-for-medium"/>')),
            ...
            if (
              ...
              (t && n.length && n.is(":visible") && (t = Number(t) + Number(n.height())),
                jQuery.scrollTo(`a[name="${e}"]`, { ...(!isNaN(t) && { offset: -t }) }));
            }
          },
          detach() {
                ...
                r.each(function (t, i) {
                  ...
                  (u.on("click", function (n) {
                    ...
                    u.on("keydown", (e) => {
                      ...
                      n &&
                        (n.find("> a").trigger("focus"), e.stopPropagation(), e.preventDefault());
                    }),
                    l &&
                      u.hoverIntent({
                        sensitivity: 3,
                    ...
                    n.substring(1).length &&
                      decodeURIComponent(n.substring(1)) === u.attr("href")?.split("#")[1] &&
                      (e(t, r, s),
                      o ||
                        ((o = !0),
                        setTimeout(() => {
      ...
      5560: function () {
        Flatsome.behavior("tooltips", {
          attach(e) {
            (jQuery(".tooltip, .has-tooltip, .tip-top, li.chosen a", e).lazyTooltipster(),
                ...
                typeof (o = function (e) {
                  ...
                  function n(t) {
                    return (
                      !t.nodeName ||
                      -1 !==
                        e.inArray(t.nodeName.toLowerCase(), ["iframe", "#document", "html", "body"])
                    );
                  }
                  function o(e) {
                            ...
                            (e.each(s.axis.split(""), function (e, n) {
                              ...
                              if (c)
                                ((p[a] = c[i] + (u ? 0 : r - h.offset()[i])),
                                  s.margin &&
                                    ((p[a] -= parseInt(f.css("margin" + o), 10) || 0),
                                    (p[a] -= parseInt(f.css("border" + o + "Width"), 10) || 0)),
                                  (p[a] += y[i] || 0),
                                  s.over[i] &&
                                    (p[a] += f["x" === n ? "width" : "height"]() * s.over[i]));
                              else {
                                var v = f[i];
                                p[a] =
                                  v.slice && "%" === v.slice(-1) ? (parseFloat(v) / 100) * g : v;
                              }
                              (s.limit &&
                                /^\d+$/.test(p[a]) &&
  ...
  ((r.m = i),
    ...
    (r.u = function (e) {
      return (
        "js/chunk." +
        { 255: "tooltips", 288: "lottie", 309: "slider", 408: "countup", 964: "popups" }[e] +
        ".js"
      );
    }),
    ...
    (function () {
      ...
      function b(e) {
        ...
        (void 0 === g &&
          void 0 === v &&
          (u.hasClass("sticky-shrink")
            ? ((g = h.hasClass("hide-for-sticky") ? h.height() : 0),
              (g += f.hasClass("hide-for-sticky") ? f.height() : 0),
              (v = 1 + g))
            : ((g = d.height() + 100), (v = h.hasClass("hide-for-sticky") ? h.height() + 1 : 1))),
          y
            ? "down" === t || e < v
              ? e < v
                ? w()
                : (m = setTimeout(w, 100))
              : e > g && (m = setTimeout(j, 100))
            : e > g
              ? j()
              : e < v && w());
      }
      ...
      function T(e) {
        (!(function (e) {
          ...
          (function (e) {
            let { element: t, type: n } = e,
              o = O(t.dataset.parallax || t.dataset.parallaxBackground),
            ...
            if (!(l.top > i || l.top + a.offsetHeight < 0))
              switch (n) {
                case "backgroundImage":
                  ((p = l.top * o),
                    (t.style.backgroundPosition = o ? `50% ${p.toFixed(0)}px` : null),
                    (t.style.backgroundAttachment = o ? "fixed" : null));
                  break;
                case "backgroundElement":
                  ((p = d * o - r / 2),
                    (t.style.transform = o ? `translate3d(0, ${p.toFixed(2)}px, 0)` : null),
                ...
                case "element":
                  ((p = h * o),
                    ...
                    void 0 !== t.dataset.parallaxFade &&
                      (t.style.opacity = o ? ((y = 1 - f), y * (2 - y)).toFixed(2) : null));
              }
          })(e));
      }
      function P(e) {
      ...
      (window.addEventListener("scroll", L, { passive: !0 }),
        ...
        new MutationObserver(L).observe(document.body, { childList: !0 }),
        window.jQuery &&
                ...
                this.each((e, t) =>
                  (function (e) {
                    (e.classList.add("parallax-active"),
                      (!document.querySelector("body").classList.contains("parallax-mobile") &&
                        /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) ||
                        (e.classList &&
                          e.dataset &&
                          (C.push({ element: e, type: P(e) }), T(C[C.length - 1]))));
                  })(t),
                ));
          }),
        r(8417),
        jQuery.fn.flickity || ((A.isFlickityStub = !0), (jQuery.fn.flickity = A)),
        (jQuery.fn.lazyFlickity = function (e) {
          const t = B((n) => {
            if (n.isIntersecting) {
              if ((t.unobserve(n.target), !jQuery.fn.flickity || jQuery.fn.flickity === A))
                return r
                  .e(309)
                ...
                const n = jQuery(e.target),
                  ...
                  i = (e) => {
                    (jQuery("body").hasClass("admin-bar") &&
                      n.before(
                        '<div class="container error"><p>Instagram error: ' + e + "</p></div>",
                      ),
                    ...
                    callbacks: {
                      ...
                      open: function () {
                        (jQuery("html").addClass("has-off-canvas"),
                          ...
                          r && jQuery(".mfp-content").addClass(r),
                          o && jQuery(".mfp-bg").addClass(o),
                          jQuery(".mfp-content .resize-select").change(),
                          jQuery.fn.packery &&
                            jQuery("[data-packery-options], .has-packery").packery("layout"),
                      ...
                      afterClose: function () {
                        (jQuery("html").removeClass("has-off-canvas-" + i),
                          ...
                          a && jQuery(e).removeClass("mfp-hide"));
                      },
                    },
                  }));
              });
            ...
            (t = jQuery(e).data("flickityOptions")
              ...
              t.each((e, t) => {
                ...
                const s = (e) => {
                  try {
                    ((a = t.contains(e.target)),
                      !i.pauseAutoPlayOnHover || a || r || n.flickity("playPlayer"));
                  } catch (e) {}
                };
                (n.on("flatsome-flickity-ready", function () {
                  ...
                  Q && ((i.friction = 1), (i.selectedAttraction = 1), (i.autoPlay = !1)),
                  n.lazyFlickity(i),
          ...
          detach(e) {
            jQuery.fn.flickity &&
              ...
              (jQuery(e).data("flickityOptions")
                ...
                : jQuery("[data-flickity-options]", e).flickity("destroy"));
          },
        }),
        r(5855),
        r(1092),
            ...
            jQuery(".accordion-title", e).each(function () {
              (jQuery(this)
                    ...
                    ? (jQuery(this)
                      ...
                      window.requestAnimationFrame(() => {
                        (jQuery.fn.flickity &&
                          ...
                          jQuery.fn.packery &&
                            jQuery(this).next().find("[data-packery-options]").packery("layout"));
                      }))
                    : jQuery(this)
                        .parent()
                        .parent()
                ...
                t.substring(1).length &&
                  decodeURIComponent(t.substring(1)) === jQuery(this).attr("href")?.split("#")[1] &&
            ...
            "ResizeObserver" in window && t.offsetParent && t.offsetParent !== document.body
              ? jQuery(t).data(
                  ...
                  (function (e) {
                    ...
                    const d = function () {
                        let t =
                          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "down";
                        ...
                        (!a || r?.height < i - n
                          ...
                          : "down" === t
                            ...
                            : "up" === t &&
                              (o <= c
                                ? ((f = n), (s = o + Math.round(r?.height) - i + n))
                                : (h = d)),
                          (h === l && f === u) ||
                            ((e.style.top = "number" == typeof f ? `${f}px` : f),
                            (e.style.transform = "number" == typeof h ? `translateY(${h}px)` : h)),
                          (u = f),
                          (l = h));
                      },
                      h = (function (e) {
                    ...
                    (t.load(n.src),
                      t.addEventListener("ready", () => {
                        ...
                        ((t.__controls = l),
                          ...
                          t.setDirection(c),
                          ("true" !== e && "scroll" === m) || o.playSegments([s(y), s(u)], !0),
                          e ||
                            (t.pause(),
                            "scroll" === m &&
                              r({
      ...
      function W() {
        (window.removeEventListener("keydown", W),
          ...
          (function () {
            ...
            ((R = Math.round(window.flatsomeVars.stickyHeaderHeight + t)),
              (window.flatsomeVars.scrollPaddingTop = R),
      ...
      document.addEventListener("DOMContentLoaded", () => {
        window.location.hash || window.scrollY > 200
          ? W()
          : (window.addEventListener("keydown", W, { once: !0 }),
            window.addEventListener("pointermove", W, { once: !0 }),
            window.addEventListener("touchstart", W, { once: !0 }));
      });
      for (const e of ["touchstart", "touchmove"])
        jQuery.event.special[e] = {
          setup(t, n, o) {
            this.addEventListener &&
              this.addEventListener(e, o, { passive: !n.includes("noPreventDefault") });
          },
        };
