                ...
                ((e.maxHeight = 0),
                  ...
                  jQuery(t, e.currentElement).each(function (t) {
                    ...
                    (a.length &&
                      ...
                      (e.swatches.dummy =
                        null !== (n = e.swatches.dummy) && void 0 !== n
                          ? n
              ...
              init: function () {
                ...
                jQuery(".equalize-box", t).each((t, o) => {
                  ((e.currentElement = o),
                    ...
                    1 !== e.colPerRow &&
                      ((e.disablePerRow =
                        jQuery(o).hasClass("row-slider") || jQuery(o).hasClass("row-grid")),
                  ...
                  (c.prototype._move = function (t) {
                    n =
                      0 === t.type.indexOf("touch")
                        ? ((s = t.touches || t.originalEvent.touches), (a = s[0].pageX), s[0].pageY)
                        : ((a = t.pageX || a), t.pageY || n);
                      ...
                      t < 0 || s < 0 || e < t || i < s
                        ...
                        : ((s *= -1),
                          ...
                          "transform" in document.body.style
                            ? this.$zoom.css({ transform: "translate(" + t + "px, " + s + "px)" })
  ...
  ((n.m = r),
    ...
    (function () {
        ...
        Flatsome.behavior("quick-view", {
          attach: function (t) {
            "uxBuilder" !== jQuery("html").attr("ng-app") &&
              jQuery(".quick-view", t).each(function (t, i) {
                jQuery(i).hasClass("quick-view-added") ||
                  (jQuery(i).on("click", function (t) {
                        ...
                        o().then(() => {
                          (jQuery(".processing").removeClass("processing"),
                            jQuery.magnificPopup.open({
                              ...
                              items: {
                                src:
                                  '<div class="product-lightbox lightbox-content">' + t + "</div>",
                                type: "inline",
                              },
                              callbacks: {
                                afterClose: () => {
      ...
      function s(t) {
        if (jQuery(".cart-item .nav-dropdown").length)
          ...
          (jQuery.fn.magnificPopup &&
            ((t = jQuery.magnificPopup.open ? 300 : 0), t && jQuery.magnificPopup.close()),
            setTimeout(function () {
      ...
      (jQuery(document).on("flatsome-product-gallery-tools-init", () => {
        (a ||
          (r = jQuery(".has-image-zoom .slide").easyZoom({ loadingNotice: "", preventClicks: !1 })),
          jQuery(".zoom-button")
            .off("click.flatsome")
        ...
        jQuery(function (t) {
          ...
          const u = function () {
              r &&
                r.length &&
                ((s = r.filter(".has-image-zoom .slide.first").data("easyZoom")),
                s.swap(
        ...
        flatsomeVars.is_mini_cart_reveal &&
          (jQuery("body").on("added_to_cart", function () {
            ...
            e &&
              ...
              (i.addClass("stuck"), t.removeClass("sticky-hide-on-scroll--active"));
          }),
        ...
        jQuery(document).ajaxComplete(function () {
          (Flatsome.attach("add-qty", jQuery(".quantity").parent()),
            Flatsome.attach(
              "lightboxes-link",
              jQuery(".woocommerce-checkout .woocommerce-terms-and-conditions-wrapper"),
            ));
        }),
