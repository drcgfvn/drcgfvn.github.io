jQuery(document).ready(function (a) {
  a("body").on("submit", "form.cart", function (t) {
    const r = a(this).parents(".type-product");
    if (r.hasClass("product-type-external") || r.hasClass("product-type-grouped")) return;
    t.preventDefault();
    const e = a(this),
    ...
    ((d += "&action=flatsome_ajax_add_to_cart"),
      ...
      o.addClass("loading"),
      a(document.body).trigger("adding_to_cart", [o, d]),
      a.ajax({
        ...
        success: function (t) {
          if (!t) return;
          const { product_url: r, notices: e, fragments: d, cart_hash: c, error: n = "" } = t;
          if (
            ...
            if (n && r) window.location = r;
              ...
              if ((o.removeClass("loading"), e.indexOf("error") > 0))
                return (
                  ...
                  void a(".woocommerce-notices-wrapper").append(e)
                );
              a(document.body).trigger("added_to_cart", [d, c, o]);
            }
