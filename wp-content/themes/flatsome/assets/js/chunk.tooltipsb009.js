        ...
        (n = function (t) {
          return (function (t) {
            ...
            ((_.prototype = {
                  ...
                  return (
                    e.indexOf(".") > 0
                      ...
                      : t.each(o.__plugins, function (t, i) {
                          return i.name.substring(i.name.length - e.length - 1) == "." + e
                            ? ((n = i), !1)
                            : void 0;
                        }),
                    n
              ...
              (t.Tooltipster.prototype = {
                  ...
                  if (
                    ...
                    if (
                      (void 0 === e._$origin.data("tooltipster-initialTitle") &&
                        (void 0 === (s = e._$origin.attr("title")) && (s = null),
                ...
                __contentSet: function (i) {
                  return (
                    i instanceof t && this.__options.contentCloning && (i = i.clone(!0)),
                    (this.__Content = i),
                ...
                __geometry: function () {
                  ...
                  for (
                    i._trigger({
                      ...
                      p.origin.offset.left = p.origin.windowOffset.left + p.window.scroll.left,
                      p.origin.offset.top = p.origin.windowOffset.top + p.window.scroll.top,
                      p.origin.offset.bottom = p.origin.offset.top + p.origin.size.height,
                      p.origin.offset.right = p.origin.offset.left + p.origin.size.width,
                      ...
                      p.available.window = {
                        bottom: {
                          height: Math.max(
                            p.window.size.height - Math.max(p.origin.windowOffset.bottom, 0),
                            0,
                          ),
                        ...
                        right: {
                          height: p.window.size.height,
                          width: Math.max(
                            p.window.size.width - Math.max(p.origin.windowOffset.right, 0),
                            0,
                          ),
                        },
                        top: {
                ...
                __prepareOrigin: function () {
                  ...
                  return (
                    (t.__options.triggerOpen.mouseenter ||
                      (t.__options.triggerOpen.touchstart && r.hasTouchCapability)) &&
                      ((i = ""),
                      t.__options.triggerOpen.mouseenter &&
                      ...
                      t._$origin.on(i, function (i) {
                        (!t._touchIsTouchEvent(i) && t._touchIsEmulatedEvent(i)) ||
                          ((t.__pointerIsOverOrigin = !0), t._openShortly(i));
                      })),
                    (t.__options.triggerClose.mouseleave ||
                      (t.__options.triggerClose.touchleave && r.hasTouchCapability)) &&
                      ((i = ""),
                      t.__options.triggerClose.mouseleave &&
                  ...
                  if (o.__options.triggerClose.scroll) o._close(i);
                    ...
                    if (i.target === r.window.document)
                      ...
                      if (
                        ...
                        (o._$tooltip.css("visibility", "visible"), o.__options.repositionOnScroll)
                      )
                        o.reposition(i);
                      else {
                ...
                __trackerStart: function () {
                  var t = this,
                    i = t._$tooltip.find(".tooltipster-content");
                  return (
                    t.__options.trackTooltip && (t.__contentBcr = i[0].getBoundingClientRect()),
                        ...
                        if (t.__options.trackOrigin) {
                          ...
                          (o(n.origin.size, t.__Geometry.origin.size) &&
                            (t.__Geometry.origin.fixedLineage
                              ? o(n.origin.windowOffset, t.__Geometry.origin.windowOffset) &&
                                (s = !0)
                              : o(n.origin.offset, t.__Geometry.origin.offset) && (s = !0)),
                            s ||
                              (t.__options.triggerClose.mouseleave ? t._close() : t.reposition()));
                        }
                      ...
                      if (
                        ...
                        r.hasTransitions
                          ? (n._$tooltip.css({
                            ...
                            n._$tooltip.queue(p))
                          : n._$tooltip.stop().fadeOut(n.__options.animationDuration[1], p);
                      }
                    } else _();
                  }
                  return n;
                    ...
                    if (
                      ...
                      if ("closed" !== n.__state)
                              ...
                              r.hasTransitions
                                ? (n._$tooltip
                                  ...
                                  n.__options.animationDuration[0] > 0 &&
                                    n._$tooltip.delay(n.__options.animationDuration[0]),
                                  n._$tooltip.queue(a))
                        ...
                        if (
                          ...
                          n.__trackerStart(),
                          t(r.window)
                            .on("resize." + n.__namespace + "-triggerClose", function (i) {
                          ...
                          n.__options.triggerClose.mouseleave ||
                            (n.__options.triggerClose.touchleave && r.hasTouchCapability))
                        ) {
                          ...
                          (n.__options.interactive && (l = l.add(n._$tooltip)),
                            n.__options.triggerClose.mouseleave &&
                              ((p += "mouseenter." + n.__namespace + "-triggerClose "),
                              (c += "mouseleave." + n.__namespace + "-triggerClose ")),
                            n.__options.triggerClose.touchleave &&
                              r.hasTouchCapability &&
                              ((p += "touchstart." + n.__namespace + "-triggerClose"),
                              (c +=
                                "touchend." +
                                n.__namespace +
                            ...
                            l
                              ...
                              .on(p, function (t) {
                                (!n._touchIsTouchEvent(t) && n._touchIsEmulatedEvent(t)) ||
                                  n._trigger({ dismissable: !1, event: t, type: "dismissable" });
                              }));
                        }
                        (n.__options.triggerClose.originClick &&
                          ...
                          (n.__options.triggerClose.click ||
                            (n.__options.triggerClose.tap && r.hasTouchCapability)) &&
                            setTimeout(function () {
                              if ("closed" != n.__state) {
                                var i = "",
                                  o = t(r.window.document.body);
                                (n.__options.triggerClose.click &&
                                  (i += "click." + n.__namespace + "-triggerClose "),
                                  n.__options.triggerClose.tap &&
                                    r.hasTouchCapability &&
                                    (i += "touchend." + n.__namespace + "-triggerClose"),
                                  o.on(i, function (i) {
                                  ...
                                  n.__options.triggerClose.tap &&
                                    r.hasTouchCapability &&
                                    o.on(
                                      "touchstart." + n.__namespace + "-triggerClose",
                                      function (t) {
                ...
                _openShortly: function (t) {
                  ...
                  if (
                    ...
                    var e =
                      0 == t.type.indexOf("touch") ? i.__options.delayTouch : i.__options.delay;
                    e[0]
                      ? (i.__timeouts.open = setTimeout(function () {
                          ((i.__timeouts.open = null),
                            i.__pointerIsOverOrigin && i._touchIsMeaningfulEvent(t)
                ...
                _touchIsEmulatedEvent: function (t) {
                  for (
                    var i = !1, o = new Date().getTime(), e = this.__touchEvents.length - 1;
                    e >= 0;
                    e--
                  ) {
                ...
                content: function (t) {
                  ...
                  if (i.__destroyed) i.__destroyError();
                    ...
                    if (
                      "closed" !== i.__state &&
                      (i.__contentInsert(), i.reposition(), i.__options.updateAnimation)
                    )
                      if (r.hasTransitions) {
                        ...
                        (i._$tooltip.addClass("tooltipster-update-" + o),
                          setTimeout(function () {
                            "closed" != i.__state &&
                              i._$tooltip.removeClass("tooltipster-update-" + o);
                          }, 1e3));
                      } else
                ...
                destroy: function () {
                  ...
                  if (i.__destroyed) i.__destroyError();
                    ...
                    ("closed" != i.__state
                      ...
                      t(r.window.document.body).off("." + i.__namespace + "-triggerOpen"));
                  ...
                  return void 0 === o
                    ...
                    : (this.__destroyed
                        ...
                        : ((this.__options[i] = o),
                          ...
                          t.inArray(i, ["trigger", "triggerClose", "triggerOpen"]) >= 0 &&
              ...
              (t.fn.tooltipster = function () {
                  ...
                  return (
                    this.each(function () {
                      ...
                      this.length > 1 &&
                        "content" == i[0] &&
                        (i[1] instanceof t ||
                          ("object" == typeof i[1] && null != i[1] && i[1].tagName)) &&
                ...
                return (
                  this.length > 1 &&
                    (a instanceof t || ("object" == typeof a && null != a && a.tagName)) &&
                    !p &&
                    h &&
                    console.log(o),
                  this.each(function () {
              ...
              (i.prototype = {
                ...
                measure: function () {
                  ...
                  return (
                    r.IE &&
                      r.IE <= 11 &&
                      i.size.width !== r.window.document.documentElement.clientWidth &&
            ...
            -1 != a.indexOf("msie")
              ...
              : -1 !== a.toLowerCase().indexOf("trident") && -1 !== a.indexOf(" rv:11")
                ? (r.IE = 11)
                : -1 != a.toLowerCase().indexOf("edge/index.html") &&
                  (r.IE = parseInt(a.toLowerCase().split("edge/index.html")[1]));
              ...
              t.tooltipster._plugin({
                ...
                instance: {
                  ...
                  __init: function (t) {
                    ...
                    ((i.__instance = t),
                      ...
                      i.__instance._on("state." + i.__namespace, function (t) {
                        ("closed" == t.state
                          ? i.__close()
                          : "appearing" == t.state && "closed" == i.__previousState && i.__create(),
                  ...
                  __create: function () {
                    ...
                    (this.__options.arrow ||
                      i
                        ...
                        .hide(),
                      this.__options.minWidth && i.css("min-width", this.__options.minWidth + "px"),
                      this.__options.maxWidth && i.css("max-width", this.__options.maxWidth + "px"),
                  ...
                  __optionsFormat: function () {
                    var i = this;
                    if (
                      ((i.__options = i.__instance._optionsExtract(l, i.__defaults())),
                      i.__options.position && (i.__options.side = i.__options.position),
                      ...
                      ((i.__options.side = [
                        ...
                        "left" == i.__options.side[0] || "right" == i.__options.side[0]
                  ...
                  __reposition: function (i, o) {
                    ...
                    switch (
                      ...
                      t.each(["window", "document"], function (e, p) {
                        ...
                        if (
                          ...
                          1 == c ||
                            (0 != c && 0 == l && ("window" != p || n.__options.viewportAware)))
                        )
                                  ...
                                  var _ = {
                                    ...
                                    u = (
                                      "natural" == e
                                        ? a.free()
                                        : a.constrain(
                                            o.geo.available[p][d].width - h.horizontal,
                                            o.geo.available[p][d].height - h.vertical,
                                          )
                                    ).measure();
                                  if (
                                    ((_.size = u.size),
                                    ...
                                    "natural" == e
                                      ? o.geo.available[p][d].width >= _.outerSize.width &&
                                        o.geo.available[p][d].height >= _.outerSize.height
                                        ? (_.fits = !0)
                                        : (_.fits = !1)
                                      : (_.fits = u.fits),
                                    "window" == p &&
                                    ...
                                    "natural" == _.mode &&
                                    (_.fits || _.size.width <= o.geo.available[p][d].width)
                                  )
                                    return !1;
                                }
                              }));
                    ...
                    ("window" == e.container
                      ? "top" == e.side || "bottom" == e.side
                        ? e.coord.left < 0
                          ? o.geo.origin.windowOffset.right - this.__options.minIntersection >= 0
                            ? (e.coord.left = 0)
                            : (e.coord.left =
                                o.geo.origin.windowOffset.right -
                                this.__options.minIntersection -
                                1)
                          : e.coord.left > o.geo.window.size.width - e.size.width &&
                            (o.geo.origin.windowOffset.left + this.__options.minIntersection <=
                            o.geo.window.size.width
                              ? (e.coord.left = o.geo.window.size.width - e.size.width)
                              : (e.coord.left =
                                  o.geo.origin.windowOffset.left +
                                  ...
                                  e.size.width))
                        : e.coord.top < 0
                          ? o.geo.origin.windowOffset.bottom - this.__options.minIntersection >= 0
                            ? (e.coord.top = 0)
                            : (e.coord.top =
                                o.geo.origin.windowOffset.bottom -
                                this.__options.minIntersection -
                                1)
                          : e.coord.top > o.geo.window.size.height - e.size.height &&
                            (o.geo.origin.windowOffset.top + this.__options.minIntersection <=
                            o.geo.window.size.height
                              ? (e.coord.top = o.geo.window.size.height - e.size.height)
                              : (e.coord.top =
                                  o.geo.origin.windowOffset.top +
                    ...
                    (a.destroy(),
                      ...
                      n.__instance._trigger({ type: "repositioned", event: i, position: e }));
                  },
