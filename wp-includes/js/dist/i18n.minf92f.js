                ...
                if ("string" == typeof t[r]) g += t[r];
                  ...
                  i.json.test(s.type)
                    ...
                    : (!i.number.test(s.type) || (p && !s.sign)
                        ? (f = "")
                        : ((f = p ? "+" : "-"), (n = n.toString().replace(i.sign, ""))),
    ...
    ((d.prototype.getPluralForm = function (t, e) {
      ...
      return (
        o ||
          ("function" !=
            typeof (i =
              (n = this.data[t][""])["Plural-Forms"] || n["plural-forms"] || n.plural_forms) &&
            ((r = (function (t) {
              var e, n, r;
      ...
      (d.prototype.dcnpgettext = function (t, e, n, r, i) {
        ...
        return (
          ...
          (s = this.data[t][a]) && s[o]
            ? s[o]
            : (this.options.onMissingKey && this.options.onMissingKey(n, t), 0 === o ? n : r)
        );
      }));
    const h = {
        plural_forms(t) {
      ...
      x = (t, e, n) => {
        ...
        return {
          ...
          addLocaleData: (t, e = "default") => {
            ((r.data[e] = { ...r.data[e], ...t, "": { ...h, ...r.data[e]?.[""], ...t?.[""] } }),
              delete r.pluralForms[e],
              o());
          },
          resetLocaleData: (t, e) => {
          ...
          _nx: (t, e, r, i, o) => {
            ...
            return n
              ? ((a = n.applyFilters("i18n.ngettext_with_context", a, t, e, r, i, o)),
                n.applyFilters("i18n.ngettext_with_context_" + l(o), a, t, e, r, i, o))
              : a;
          },
